...
var COLORS = ["#d32f2f", "#c62828", "#b71c1c", "#d50000", "#e91e63", "#d81b60", "#c2185b", "#ad1457", "#880e4f", "#f50057", "#c51162", "#ab47bc", "#9c27b0", "#8e24aa", "#7b1fa2", "#6a1b9a", "#4a148c", "#d500f9", "#aa00ff", "#673ab7", "#5e35b1", "#512da8", "#4527a0", "#311b92", "#6200ea", "#3f51b5", "#3949ab", "#303f9f", "#283593", "#1a237e", "#1e88e5", "#1976d2", "#1565c0", "#0d47a1", "#03a9f4", "#039be5", "#0288d1", "#0277bd", "#01579b", "#00b0ff", "#0091ea", "#26c6da", "#00bcd4", "#00acc1", "#0097a7", "#00838f", "#006064", "#00e5ff", "#00b8d4", "#4db6ac", "#26a69a", "#009688", "#00897b", "#00796b", "#00695c", "#004d40", "#1de9b6", "#00bfa5", "#4caf50", "#43a047", "#388e3c", "#2e7d32", "#1b5e20", "#00e676", "#00c853", "#7cb342", "#689f38", "#558b2f", "#33691e", "#76ff03", "#64dd17", "#c0ca33", "#afb42b", "#9e9d24", "#827717", "#c6ff00", "#aeea00", "#f57f17", "#ffff00", "#ffea00", "#ffd600", "#ffc107", "#ffb300", "#ffa000", "#ff8f00", "#ff6f00", "#ffc400", "#ffab00", "#ff9800", "#fb8c00", "#f57c00", "#ef6c00", "#e65100", "#ff9100", "#ff6d00", "#e64a19", "#d84315", "#bf360c", "#ff3d00", "#dd2c00", "#607d8b", "#546e7a", "#455a64", "#37474f", "#263238"];
exports.default = COLORS;
var COLORS_LENGTH = exports.COLORS_LENGTH = COLORS.length;
...
var _Start = __webpack_require__(/*! ./pages/Start */ "./src/js/components/pages/Start.js");

var _Game = __webpack_require__(/*! ./pages/Game */ "./src/js/components/pages/Game.js");

var _Game2 = _interopRequireDefault(_Game);

var _Score = __webpack_require__(/*! ./pages/Score */ "./src/js/components/pages/Score.js");
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.getPage = function () {
            switch (_this.props.currentPage) {
                case 0:
                    return _react2.default.createElement(_Start.Start, null);
                case 1:
                    return _react2.default.createElement(_Game2.default, null);
                case 2:
                    return _react2.default.createElement(_Score2.default, null);
                case 3:
                    return _react2.default.createElement(_Start.Start, null);
            }
...
/***/ "./src/js/components/pages/Game.js":
/*!*****************************************!*\
  !*** ./src/js/components/pages/Game.js ***!
  \*****************************************/
/*! no static exports found */
...
var _levels = __webpack_require__(/*! ../../levels */ "./src/js/levels.js");

var _color = __webpack_require__(/*! color */ "./node_modules/color/index.js");

var _color2 = _interopRequireDefault(_color);

var _store = __webpack_require__(/*! ../../redux/store */ "./src/js/redux/store.js");

var _store2 = _interopRequireDefault(_store);

var _app = __webpack_require__(/*! ../../redux/actions/app */ "./src/js/redux/actions/app.js");
...
var Cell = function Cell(_ref) {
    var color = _ref.color,
        isActiveClick = _ref.isActiveClick;
    return _react2.default.createElement('div', { className: 'cell', style: { background: color }, onClick: isActiveClick });
};
...
var Timer = function (_Component) {
    ...
    function Timer(props) {
        ...
        var interval = setInterval(function () {
            var currentSecond = _this.state.currentSecond;
            var _this$props = _this.props,
                to = _this$props.to,
                clearTimer = _this$props.clearTimer;
            ...
            if (currentSecond === to + 1) {
                ...
                _this.setState({ currentSecond: currentSecond });
            }
        }, 1000);
        return _this;
    }
    ...
    _createClass(Timer, [{
        ...
        value: function render() {
            ...
            var currentSecond = this.state.currentSecond;
...
var Board = function (_Component2) {
    ...
    function Board() {
        ...
        return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref3 = Board.__proto__ || Object.getPrototypeOf(Board)).call.apply(_ref3, [this].concat(args))), _this2), _this2.activeClick = function () {
            return _store2.default.dispatch((0, _app.nextLevel)(_this2.props.score, _this2.props.currentLevel, _this2.props.rows, _this2.props.lighten));
        }, _this2.getCells = function () {
            var cells = [];
            var _this2$props = _this2.props,
                countCells = _this2$props.countCells,
                activeCell = _this2$props.activeCell,
                color = _this2$props.color,
                lighten = _this2$props.lighten;
            //let color = '#ff0000'

            for (var i = 0; i < countCells; i++) {
                var isActiveClick = i === activeCell ? _this2.activeClick : null;
                cells.push(_react2.default.createElement(Cell, { key: i, color: i === activeCell ? (0, _color2.default)(color).lighten(lighten).toString() : color, isActiveClick: isActiveClick }));
            }
            return cells;
...
var Game = function (_Component3) {
    ...
    function Game() {
        ...
        return _ret2 = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_ref4 = Game.__proto__ || Object.getPrototypeOf(Game)).call.apply(_ref4, [this].concat(args))), _this3), _this3.getRandomInt = function (min, max) {
            return Math.floor(Math.random() * (max - min + 1)) + min;
        }, _this3.getColor = function () {
            return _colors2.default[_this3.getRandomInt(0, _colors.COLORS_LENGTH - 1)];
        }, _this3.getActiveCell = function (countCells) {
            return _this3.getRandomInt(0, countCells - 1);
        }, _this3.callbackTimer = function () {
            return _store2.default.dispatch((0, _app.changePage)(2));
    ...
    _createClass(Game, [{
        ...
        value: function render() {
            ...
            var optionsLevel = _levels.LEVELS[currentLevel];
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'info' },
                    _react2.default.createElement(Score, { score: score }),
                    _react2.default.createElement(Timer, { to: 30, clearTimer: this.callbackTimer })
                ),
                _react2.default.createElement(Board, _extends({}, optionsLevel, { score: score }))
            );
        }
    }]);
...
/***/ "./src/js/components/pages/Score.js":
/*!******************************************!*\
  !*** ./src/js/components/pages/Score.js ***!
  \******************************************/
/*! no static exports found */
    ...
    _createClass(Score, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'button', className: 'btn', value: 'Retry', onClick: function onClick(e) {
                        return _store2.default.dispatch((0, _app.refreshGame)());
                    } })
            );
        }
    }]);
...
/***/ "./src/js/components/pages/Start.js":
/*!******************************************!*\
  !*** ./src/js/components/pages/Start.js ***!
  \******************************************/
/*! no static exports found */
...
var Start = exports.Start = function Start() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'button', className: 'btn', value: 'Start', onClick: function onClick(e) {
                return _store2.default.dispatch((0, _app.changePage)(1));
            } })
    );
};
...
var LEVELS = exports.LEVELS = (_LEVELS = {
    1: {
        rows: 2,
        lighten: 0.6
    },
...
}, _defineProperty(_LEVELS, "22", {
    rows: 6,
    lighten: 0.11
}), _defineProperty(_LEVELS, 23, {
    rows: 6,
    lighten: 0.1
}), _LEVELS);

var MAX_LEVEL = exports.MAX_LEVEL = 23;

/***/ }),

/***/ "./src/js/redux/actions/app.js":
/*!*************************************!*\
  !*** ./src/js/redux/actions/app.js ***!
  \*************************************/
/*! no static exports found */
...
exports.refreshGame = exports.nextLevel = exports.changePage = undefined;

var _constants = __webpack_require__(/*! ../constants */ "./src/js/redux/constants.js");

var changePage = exports.changePage = function changePage(page) {
    return { type: _constants.CHANGE_PAGE, newPage: page };
};

var nextLevel = exports.nextLevel = function nextLevel(score, currentLevel, rows, lighten) {
    var newScore = score + currentLevel * rows * lighten * 100;
    return { type: _constants.NEXT_LEVEL, score: newScore };
};

var refreshGame = exports.refreshGame = function refreshGame() {
    return { type: _constants.REFRESH_GAME };
};
...
var REFRESH_GAME = exports.REFRESH_GAME = 'REFRESH_GAME';

/***/ }),

/***/ "./src/js/redux/reducers/app.js":
/*!**************************************!*\
  !*** ./src/js/redux/reducers/app.js ***!
  \**************************************/
/*! no static exports found */
...
exports.default = function () {
    ...
    switch (action.type) {
        ...
        case _constants.NEXT_LEVEL:
            var currentLevel = state.currentLevel < _levels.MAX_LEVEL ? state.currentLevel + 1 : _levels.MAX_LEVEL;
            return _extends({}, state, {
                currentLevel: currentLevel,
                score: action.score
            });
        case _constants.REFRESH_GAME:
...
var _app = __webpack_require__(/*! ./app */ "./src/js/redux/reducers/app.js");
...
var _reducers = __webpack_require__(/*! ./reducers */ "./src/js/redux/reducers/index.js");
...
var rootReducer = (0, _redux.combineReducers)(_extends({}, _reducers2.default));

var initialState = {};
var enhancers = [];
var middleware = [];

var composedEnhancers = _redux.compose.apply(undefined, _toConsumableArray(_redux.applyMiddleware.apply(undefined, middleware)).concat(enhancers));
